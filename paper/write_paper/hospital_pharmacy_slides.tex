...
\begin{itemize}
    ...
    \item Indicator(0/1)
    \begin{itemize}
    \item Estimates: Positive and statistically significant within 2-3 km.
    \item Parallel trend assumption: 1 km satisfied,2-3km almost satisfied.
    \end{itemize}
...
\begin{frame}{Extensive Margin: Pharmacy Presence (0/1)}

\textbf{Outcome: Indicator for Any Pharmacy Around Hospitals}
...
\begin{itemize}
    \item Reform \textbf{increases the probability of pharmacy presence} within 2–3 km.
\end{itemize}

\end{frame}

\begin{frame}{Extensive Margin: Switchers Sample Only}

\textbf{Sample: Hospitals with at least one zero outcome}
...
\textbf{Interpretation}
\begin{itemize}
    \item Within hospitals that experience entry/exit, the reform \textbf{reduces the probability of pharmacy presence within 1 km} by about 2 percentage points.
    \item No statistically significant effects at 2–3 km.
    \item Suggests a \textbf{local contraction effect} rather than spatial expansion.
\end{itemize}

\end{frame}


\begin{frame}{Quantile Results}

\textbf{Quantile Treatment Effects}
...
\toprule
 & Q25 & Q50 & Q75 \\
\midrule
1km & -0.419*** & -0.072*** & -0.087* \\
     & (0.040)  & (0.021)  & (0.049) \\

2km & -0.931*** & -0.171**  & -0.157 \\
     & (0.100)  & (0.060)   & (0.123) \\

3km & -1.237*** & 0.206     & 0.281 \\
     & (0.158)  & (0.109)   & (0.199) \\
\midrule
Observations & \multicolumn{3}{c}{193,010} \\
\bottomrule
\end{tabular}
\end{table}
...
% ========== Event Study:Dummy==========
\begin{frame}{Event Study:Dummy}

\begin{itemize}
    \item Outcome: Indicator of Pharmacy entry around hospitals (within 1km)
    \item Fixed effects: hospital and year
    \item Standard errors : clustered at  county level
\end{itemize}
...
\vspace{0.5em}
\begin{center}
\includegraphics[width=0.8\textwidth]{parallel_dummy_1km.png}
\end{center}
...
\begin{itemize}
    \item Outcome: Indicator of Pharmacy entry around hospitals (within 2km)
    \item Fixed effects: hospital and year
    \item Standard errors : clustered at  county level
\end{itemize}
...
\vspace{0.5em}
\begin{center}
\includegraphics[width=0.8\textwidth]{parallel_dummy_2km.png}
\end{center}
...
\begin{itemize}
    \item Outcome: Indicator of Pharmacy entry around hospitals (within 3km)
    \item Fixed effects: hospital and year
    \item Standard errors : clustered at  county level
\end{itemize}
...
\vspace{0.5em}
\begin{center}
\includegraphics[width=0.8\textwidth]{parallel_dummy_3km.png}
\end{center}
...
% ========== CS-DID回归结果（dummy)==========
\begin{frame}{Baseline DID Results: CS-DID-Dummy}
